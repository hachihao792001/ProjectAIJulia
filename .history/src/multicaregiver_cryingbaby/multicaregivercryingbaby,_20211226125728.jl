...
function joint_observation(pomg::BabyPOMG, a, s′, o)
    ...
    if a[1] == SING || a[2] == SING
        ...
        #   +Observation của cả 2 đều là CRYING -> tỷ lệ CRYING_HUNGRY_SING
        #   +Observation của cả 2 đều là QUIET  -> tỷ lệ QUITED_HUNGRY_SING = 1 - CRYING_HUNGRY_SING
        ...
        #   +Observation 1 trong 2 là CRYING     -> tỷ lệ QUIED  = 0%
        else
